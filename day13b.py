...
for line in lines:
    ...
    if line.startswith("Button A:"):
        ...
        prize_locs.append((int(nums[0]) + 10000000000000, int(nums[1]) + 10000000000000))

def is_whole(num):
    return (num % 1 > .999 or num % 1 < 0.001) 
...
for idx, loc in enumerate(prize_locs):
    ...
    print(answers)
    cost = 0
    if is_whole(answers[0]) and is_whole(answers[1]) and answers[0] > -1 and answers[1] > -1:
